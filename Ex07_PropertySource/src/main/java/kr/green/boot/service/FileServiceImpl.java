...
public class FileServiceImpl implements FileService {
	...
	// Value 어노테이션은 프로퍼티 파일 안에 저장된 변수를 읽어서 주입시켜준다.
	...
	@Value("#{config['jdbc.password']}") // #{아이디['키']} utill:properties로 읽을 경우
	private String password2;
	@Override
	public void readValues() {
		
		System.out.println("------------------------------------------------------------");
		System.out.println("사용자 비번 : " + environment.getProperty("jdbc.password"));
		System.out.println("------------------------------------------------------------");
		...
		System.out.println("사용자 이름 : " + environment.getProperty("jdbc.username"));
		System.out.println("사용자 비번 : " + environment.getProperty("jdbc.password"));
